...
public class _4_Balanced_Brackets {

	// if brackets are balanced i.e
	// closing or opening bracket is not present : a bracket opened but not closed
	// and vice-versa
	...
	public static boolean balancebrackets(String str) {
		...
		// if size is 0 then all brackets have matching pair else some opening brackets
		// are left
